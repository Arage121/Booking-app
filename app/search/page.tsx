            ...
            >
              ...
              <div className="flex flex-1 space-x-5 justify-between">
                <div>
                  <Link
                    href={item.link}
                    className="font-bold text-black hover:text-[#56565a] hover:underline"
                  >
                    {item.title}
                  </Link>
                ...
                <div className="flex flex-col justify-between">
                  <div className="flex items-start justify-end space-x-2 text-right">
                    ...
                    <p className="flex items-center justify-center font-bold text-sm w-10 h-10 text-white bg-[#56565a] rounded-lg flex-shrink-0">
                      {item.rating || "N/A"}
                    </p>
                  </div>
